...
//           Image.asset(
//             audioPlayerProvider.albumArtPath,
//             height: 300,
//           ),
...
//                         child: ProgressBar(
//                           progress: duration,
//                           total: audioPlayerProvider.player.duration ?? const Duration(seconds: 0),
...
//                 onPressed: audioPlayerProvider.loaded
//                     ? () async {
//                         if (audioPlayerProvider.player.position.inSeconds >= 10) {
//                           await audioPlayerProvider.player.seek(Duration(
//                               seconds: audioPlayerProvider.player.position.inSeconds - 10));
//                         } else {
//                           await audioPlayerProvider.player.seek(const Duration(seconds: 0));
//                         }
//                       }
//                     : null,
...
//                       : null,
//                   icon: Icon(
//                     audioPlayerProvider.playing ? Icons.pause : Icons.play_arrow,
//                     color: Colors.white,
//                   ),
//                 ),
//               ),
...
//         await player.setFilePath(newMusicFile);
//       }
